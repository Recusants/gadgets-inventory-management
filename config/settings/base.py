"""
Base Django settings for 21 Void Technologies - Record Keeping System.
"""
...
MIDDLEWARE = [
    ...
    'core.middleware.RoleSessionTimeoutMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.company_settings_processor',
            ],
        },
    },
]
...
# Session security (8 hours for staff, 1 hour for admin handled in middleware/decorator)
